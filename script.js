let product = {
    ...
    Qoraburger: {
        ...
        amount: 0,
        descr: 'Тамига жовоп',
        img: 'https://msk.tokyo-city.ru/goods/1burger_chicken.jpg',
        get SUMM() {
            return this.price * this.amount
        },
        get KCALL() {
    ...
    Plovcombo: {
        ...
        kcall: 3600,
        amount: 0,
        descr: 'Especially for uzbek people',
        img: 'https://pic.rutubelist.ru/video/df/41/df4137f96639ea07048d6a015664bf55.jpg',
        get SUMM() {
            return this.price * this.amount
        },
        get KCALL() {
    ...
    Qorachoy: {
        ...
        amount: 0,
        descr: 'ob-havoga mos',
        img: 'https://on-desktop.com/wps/2017Food___Drinks_A_cup_of_black_tea_with_ginger_113462_.jpg',
        get SUMM() {
            return this.price * this.amount
        },
        get KCALL() {
...
function countdown(){
  ...
  if (x == 101){
    ...
    timer = setTimeout(countdown, 150);
  }
  else{
    timer = setTimeout(countdown, 150);
  }
